              ...
              <div>
                <div className="datas">
                  <div>
                    ...
                    <button type="button" className="close" aria-label="Close" onClick={this.removeTitle.bind(this, titleIndex)}>
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  {data.items.map((item, taskIndex) => <h4 key={item}>
                  ...
                  <button onClick={this.addTask.bind(this, titleIndex)}>Add</button>
                </div>
              </div>
            )
          }
